        ...
        showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                content: Text(AppLocalizations.of(context).changesUpdatedNotSuccessfull),
                actions: [
                  FlatButton(
                    child: Text(AppLocalizations.of(context).ok),
                    onPressed: () {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        onPressed:() => Navigator.of(context).pushReplacementNamed(FullProfile.routeName),
        ),
                        ...
                        child: Center(
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                if (value.isEmpty || value.length<5) {
                                  return AppLocalizations.of(context).invalidDepartment;
                                }
                                return null;
                              },
                            ),
