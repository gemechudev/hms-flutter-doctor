                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                (_tempappointmentlistdata[index].status == "Confirmed")? 
                                                  Expanded(
                                                    child: Container(
                                                        width: 35,
                                                        height: 30,
                                                              ...
                                                              MaterialPageRoute(
                                                                  builder: (context) => Jitsi(
                                                                      ...
                                                                      d_name: _tempappointmentlistdata[index]
                                                                          .doctor_name,
                                                                      d_date: _tempappointmentlistdata[
                                                                              index]
                                                                          .date,
                                                      ...
                                                      style: ButtonStyle(
                                                          ...
                                                          shape: MaterialStateProperty.all<
                                                              ...
                                                              RoundedRectangleBorder(
                                                                  ...
                                                                  side: BorderSide(color: Colors.black12)))),
                                                      onPressed: () {
                                                        Future<String> deleteAppointment(  context) async {
                                                          String posturl = Auth().linkURL + "api/deleteAppointment?id=${_tempappointmentlistdata[index].id}";
                                                          ...
                                                          if (res.statusCode ==  200 && res.body == '\"success\"') {
                                                            await showDialog(
                                                                ...
                                                                builder:  (BuildContext context) {
                                                                  return AlertDialog(
                                                                    ...
                                                                    content: Text(AppLocalizations.of(  context)  .appointmentWasDeleted),
                                                                    actions: [
                                                                      FlatButton(
                                                            ...
                                                            return 'success';
                                                          } else if (res.statusCode ==  200 &&  res.body ==  '\"failed\"') {
                                                            showDialog(  
                                                              context: context,
                                                                builder: (BuildContext  context) {
                                                                  return AlertDialog(
                                                                    title: Text(AppLocalizations.of(context).failed),
                                                                    content: Text( AppLocalizations.of(context).appointmentWasNotDeleted),
                                                                    actions: [
                                                                      FlatButton(
                                                        ...
                                                        setState(() {
                                                          showDialog(
                                                            ...
                                                            builder: (BuildContext context) {
                                                              return AlertDialog(
                                                                title: Text(AppLocalizations.of(context).deleteappointmentconfirmation),
                                                                content: Text(AppLocalizations.of(context).doyoureallywanttodeletetheappointment),
                                                                actions: [
                                                                  TextButton(
                                                                    child: Text(AppLocalizations.of(context).close),
                                                                    onPressed: () {
